...
<div :class="{ 'dark': darkMode === true }">
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    <div class="flex justify-end items-center space-x-2">
                        ...
                        @else
                            ...
                            <a href="{{ route('register') }}" class="block py-2 text-sm text-gray-300">
                                Register
                            </a>
                        @endauth
                    </div>
                ...
                <div class="py-6 px-5 space-y-6">
                    ...
                    <div class="mt-6 border-t border-gray-400 pt-4 text-base font-medium text-gray-300">
                        ...
                        @else
                            ...
                            <a href="{{ route('register') }}" class="text-base font-medium text-gray-300">
                                Register
                            </a>
                        @endauth
                    </div>
    ...
    <footer class="bg-slate-100 dark:bg-slate-800" aria-labelledby="footerHeading">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-10">
            <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
                ...
                <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                    ©{{ config('app.name') }} {{ date('Y') .'-'. (date('Y')+1) }}. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
